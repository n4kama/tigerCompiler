...
namespace yy {
#line 119 "src/parse.hh" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    parser (int& res_yyarg, int& err_nb_yyarg);
    virtual ~parser ();
...
#line 937 "src/parse.hh" // lalr1.cc:377


// //                    "%code provides" blocks.
#line 13 "src/parse.yy" // lalr1.cc:377

    #define YY_DECL yy::parser::symbol_type yylex(int& err_nb)
    extern FILE *yyin;
    YY_DECL;

#line 947 "src/parse.hh" // lalr1.cc:377
